...
const analysisFile = path.join(__dirname, 'referrals_analysis.txt');
  ...
  try {
    ...
    ws.on('open', async () => {
      ...
      try {
        ...
        console.log("Navigating to https://dealwork.ai/dashboard/referrals...");
        await sendCommand("Page.navigate", { url: "https://dealwork.ai/dashboard/referrals" });

        console.log("Waiting 3 seconds for page to load...");
        await sleep(3000);

        console.log("Extracting referrals page information...");
        ...
        if (res.exceptionDetails) {
          ...
          let report = `--- Chrome Referrals Page Analysis ---\n`;
          ...
          console.log(`Saved referrals analysis to ${analysisFile}`);
        }
